// cogitatio-virtualis/cogitation-terminal/components/Terminal/controllers/BaseController.ts

import type { PrintableItem, TerminalHandle, TerminalConfig } from '../types/terminal';
import type { DeepPartial } from '@/components/Terminal/utils/deepMerge';
import type { Controller, ControllerState, ControllerStatus } from '@/components/Terminal/controllers/types';
...
export abstract class BaseController implements Controller {
   ...
   */
  protected async enqueueOperation(operation: () => Promise<void>): Promise<void> {
